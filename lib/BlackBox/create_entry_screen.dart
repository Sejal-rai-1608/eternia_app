...
class _CreateEntryScreenState extends State<CreateEntryScreen> {
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text("New Reflection", style: GoogleFonts.cormorantGaramond(color: primaryColor, fontSize: 24, fontWeight: FontWeight.bold)),
                  GestureDetector(
                    onTap: () => Navigator.pop(context),
                    child: Text("Save", style: GoogleFonts.poppins(color: primaryColor, fontWeight: FontWeight.bold)),
                  ),
                ],
              ),
            ),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("HOW ARE YOU FEELING?", style: GoogleFonts.poppins(color: primaryColor.withOpacity(0.6), fontSize: 10, letterSpacing: 2, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 20),
                    _buildMoodSelector(primaryColor, isDark, cardColor, borderColor),
                    const SizedBox(height: 40),
                    Text("YOUR THOUGHTS", style: GoogleFonts.poppins(color: primaryColor.withOpacity(0.6), fontSize: 10, letterSpacing: 2, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 20),
                    _buildTextField(isDark, cardColor, borderColor),
                    const SizedBox(height: 40),
                    _buildRecordToggle(primaryColor, isDark, cardColor, borderColor),
                  ],
                ),
              ),
            ),
  ...
  Widget _buildMoodSelector(Color primaryColor, bool isDark, Color cardColor, Color borderColor) {
    return Container(
      height: 100,
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Icon(moods[index]['icon'], color: isSelected ? (isDark ? Colors.black : Colors.white) : primaryColor, size: 28),
                  const SizedBox(height: 8),
                  Text(moods[index]['label'], style: GoogleFonts.poppins(color: isSelected ? (isDark ? Colors.black : Colors.white) : Colors.grey, fontSize: 10, fontWeight: FontWeight.w600)),
                ],
              ),
            ),
          );

  ...
  Widget _buildControls(bool isDark, Color primary) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          _buildCircleBtn(Icons.mic_off_outlined, isDark ? Colors.grey : Colors.black45, isDark: isDark),
          _buildCircleBtn(Icons.call_end, Colors.red, isEnd: true, isDark: isDark),
          _buildCircleBtn(Icons.volume_up_outlined, isDark ? Colors.grey : Colors.black45, isDark: isDark),
        ],
      ),
    );
  }

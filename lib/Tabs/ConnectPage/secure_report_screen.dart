                  ...
                  if (!isSubmitted) ...[
                    ...
                    Text(
                      ...
                      style: GoogleFonts.poppins(
                          color: textSecondary, fontSize: 11, height: 1.6),
                    ),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Center(
                            child: Text("SUBMIT ENCRYPTED REPORT",
                                style: GoogleFonts.poppins(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                    fontSize: 14,
                    ...
                    Center(
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                const SizedBox(height: 8),
                                Text(
                                    "Save this ID to track updates anonymously.",
                                    style: GoogleFonts.poppins(
                          ...
                          GestureDetector(
                            onTap: () => Navigator.pop(context),
                            child: Text("Return to Sanctuary",
                                style: GoogleFonts.poppins(
                                    color: primary,
                                    fontWeight: FontWeight.bold,
                                    fontSize: 14)),

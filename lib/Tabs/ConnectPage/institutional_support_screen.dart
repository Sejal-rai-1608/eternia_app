...
class InstitutionalSupportScreen extends StatefulWidget {
  ...
  @override
  State<InstitutionalSupportScreen> createState() =>
      _InstitutionalSupportScreenState();
}

class _InstitutionalSupportScreenState
    extends State<InstitutionalSupportScreen> {
  final TextEditingController _searchController = TextEditingController();
  bool isJoined = false;
  String? selectedOrg;

  final List<String> _popularOrgs = [
    "SJCEM College",
    "SteelWorks Corp",
    "St. John University",
    "Eternia Sanctuary"
                  ...
                  if (!isJoined) ...[
                    Text("POPULAR NEARBY",
                        style: GoogleFonts.poppins(
                            ...
                            fontWeight: FontWeight.bold)),
                    const SizedBox(height: 12),
                    ..._popularOrgs.map((org) => _buildOrgItem(org, isDark,
                        primary, cardColor, borderColor, textPrimary)),
                  ] else ...[
                    // JOINED VIEW
                    _buildActiveOrgHeader(selectedOrg!, primary, cardColor,
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                  child: Text("Start Secure Report",
                                      style: GoogleFonts.poppins(
                                          color: Colors.white,
                                          fontWeight: FontWeight.bold,
                                          fontSize: 13))),
  ...
  Widget _buildOrgItem(String name, bool isDark, Color primary, Color cardColor,
  ...
  Widget _buildActiveOrgHeader(String name, Color primary, Color cardColor,
      Color borderColor, Color textPrimary) {
    return Container(
      padding: const EdgeInsets.all(24),
      decoration: BoxDecoration(
      ...
      child: Row(
        children: [
          ...
          TextButton(
              onPressed: () => setState(() => isJoined = false),
  ...
  Widget _buildExpertSmall(String name, String role, String imgUrl,
      Color primary, Color cardColor, Color borderColor, Color textPrimary) {
    return Container(
  ...
  Widget _buildEventCard(String title, String time, Color primary,

...
class _DailyCheckinScreenState extends State<DailyCheckinScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Icon(Icons.close,
                          color: theme.iconSecondary, size: 18),
                    ),
                  ),
                  Container(
                    padding: const EdgeInsets.all(12),
              ...
              Text(
                  "Take a mindful moment to reflect on your energy and emotions.",
                  style: GoogleFonts.poppins(
                      color: theme.textTertiary, fontSize: 13, height: 1.5)),
              ...
              GestureDetector(
                onTap: () {
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                    content:
                        Text('Check-in Saved', style: GoogleFonts.poppins()),
  ...
  Widget _buildSliderCard(String title, IconData icon, double value,
      ValueChanged<double> onChanged, EterniaTheme theme, bool isDark) {
    return Container(
        ...
        children: [
          ...
          SliderTheme(
            data: SliderThemeData(
              ...
              inactiveTrackColor: theme.primary.withValues(alpha: 0.15),
